/* ===========================================================
 * trumbowyg.emojicat.js v0.1
 * Categorized emoji picker plugin for Trumbowyg
...
(function ($) {
    ...
    $.extend(true, $.trumbowyg, {
        langs: {
            ...
            en: {
                emojicat: 'Add an emoji'
            },
            da: {
                emojicat: 'Tilføj et humørikon'
            },
            de: {
                emojicat: 'Emoticon einfügen'
            },
            fr: {
                emojicat: 'Ajouter un emoji'
            },
            zh_cn: {
                emojicat: '添加表情'
            },
            ru: {
                emojicat: 'Вставить emoji'
            },
            ja: {
                emojicat: '絵文字の挿入'
            },
        ...
        plugins: {
            emojicat: {
                init: function (trumbowyg) {
                    trumbowyg.o.plugins.emojicat = $.extend(true, {},
                      defaultOptions,
                      trumbowyg.o.plugins.emojicat || {}
                    );

                    trumbowyg.addBtnDef('emojicat', buildButtonDef(trumbowyg));
                }
            }
        }
    });
    ...
    /**
     * Builds plugin button definition.
     *
     * @param {{}} trumbowyg
     *
    ...
    function buildButtonDef(trumbowyg) {
        return {
            ...
            alterDropdown: function ($dropdown) {
                var prefix = trumbowyg.o.prefix,
                    options = trumbowyg.o.plugins.emojicat,
                    $header = $('<div class="' + prefix + 'dropdown-header"></div>');

                // Add categories to the dropdown.
                $.each(options.categoryList, function (i, category) {
                    var $btn = $('<button class="category-toggle emoji-category-' + category + '">' + category + '</button>');
                    $btn
                ...
                toggleCategory(options.categoryList[0]);

                $dropdown.prepend($header);

                /**
                 * Toggles emoji category.
                 *
                ...
                function toggleCategory(category) {
                    ...
                    $header
                      ...
                      .removeClass('active')
                      .filter('.emoji-category-' + category)
                      .addClass('active');
                }
            }
        }
